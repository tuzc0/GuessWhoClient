...
namespace GuessWhoClient.Presentation.Views.UserControls
{
    ...
    {
        private static readonly ILog Logger = LogManager.GetLogger(typeof(VerifyEmailView));
        ...
        public VerifyEmailView(long accountId, string email, UserServiceClient client)
        {
            InitializeComponent();
