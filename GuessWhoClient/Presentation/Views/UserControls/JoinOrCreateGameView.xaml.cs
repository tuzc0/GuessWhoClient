...
{
    public partial class JoinOrCreateGameView : UserControl
    {
        private static readonly ILog Logger = LogManager.GetLogger(typeof(JoinOrCreateGameView));
        ...
        private static IReadOnlyList<LobbyPlayer> MapLobbyPlayers(ServiceLobbyPlayerDto[] players)
        {
            return LobbyPlayerMapper.ToDomainList(players);
        }
